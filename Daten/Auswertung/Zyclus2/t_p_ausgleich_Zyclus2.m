...
%%
clear all
load('C:\Users\Sebi\Dropbox\Studium\Semester 8\Bachelorarbeit\StoneMon\Daten\Auswertung\Zyclus2\workspace-zylclus2.mat')
...
figure(1)
set(gca,'Fontsize',10);
title('T- \rho - Diagramm Zyklus2 Reihe1 (Klebeelektroden)','Fontsize',10)
...
figure(2)
set(gca,'Fontsize',10);
title('T- \rho - Diagramm Zyklus2 Reihe2 (Galvanisch)','Fontsize',10)
ylabel('Resistivity in [\Omega m]','Fontsize',10)
xlabel('Temperatur in [°C]','Fontsize',10)
grid on
axis([-7 11 -500 15000])
...
figure(3)
set(gca,'Fontsize',10);
title('T- \rho - Diagramm Zyklus2 Reihe3 (Klebeelektroden)','Fontsize',10)
ylabel('Resistivity in [\Omega m]','Fontsize',10)
xlabel('Temperatur in [°C]','Fontsize',10)
grid on
axis([-7 11 -500 15000])
...
figure(4)
set(gca,'Fontsize',10);
title('T- \rho - Diagramm Zyklus2 Reihe4 (Galvanisch)','Fontsize',10)
ylabel('Resistivity in [\Omega m]','Fontsize',10)
xlabel('Temperatur in [°C]','Fontsize',10)
grid on
axis([-7 11 -500 15000])
...
figure(5)
set(gca,'Fontsize',10);
title('T- \rho - Diagramm Zyklus2 Reihe5 (Klebeelektroden)','Fontsize',10)
ylabel('Resistivity in [\Omega m]','Fontsize',10)
xlabel('Temperatur in [°C]','Fontsize',10)
grid on
axis([-6 10 -50 700])
...
% 
% writetable(Tabelle, 'Ausgleichsgerade_Zyclus2.txt')
% 
% 
% print( figure(1), '-djpeg','-r400', 'C:\Users\Sebi\Dropbox\Studium\Semester 8\Bachelorarbeit\StoneMon\Grafiken\t-p-Kurven\Zyclus2-Reihe1.jpg');
% print( figure(2), '-djpeg','-r400', 'C:\Users\Sebi\Dropbox\Studium\Semester 8\Bachelorarbeit\StoneMon\Grafiken\t-p-Kurven\Zyclus2-Reihe2.jpg');
% print( figure(3), '-djpeg','-r400', 'C:\Users\Sebi\Dropbox\Studium\Semester 8\Bachelorarbeit\StoneMon\Grafiken\t-p-Kurven\Zyclus2-Reihe3.jpg');
% print( figure(4), '-djpeg','-r400', 'C:\Users\Sebi\Dropbox\Studium\Semester 8\Bachelorarbeit\StoneMon\Grafiken\t-p-Kurven\Zyclus2-Reihe4.jpg');
% print( figure(5), '-djpeg','-r400', 'C:\Users\Sebi\Dropbox\Studium\Semester 8\Bachelorarbeit\StoneMon\Grafiken\t-p-Kurven\Zyclus2-Reihe5.jpg');
% 
